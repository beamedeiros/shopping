...
namespace Ean13Barcode2005
{
	public class CodigoBarras
	{
		...
		public CodigoBarras( string mfgNumber, string productId )
		{
			this.CountryCode = "00";
		...
		public CodigoBarras( string countryCode, string mfgNumber, string productId )
		{
		...
		public CodigoBarras( string countryCode, string mfgNumber, string productId, string checkDigit )
		{
			this.CountryCode = countryCode;
			this.ManufacturerCode = mfgNumber;
			this.ProductCode = productId;
