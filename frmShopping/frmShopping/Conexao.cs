...
namespace frmShopping
{
    static class Conexao
    {
        ...
        public static String criar_Conexao()
        {
            ...
            string configuracao = string.Format("server={0};user id={1}; password={2};database=mysql; pooling=false", "127.0.0.1", "root", "toor");
            ...
            MySqlCommand usar = new MySqlCommand("use shopping", conectar);
